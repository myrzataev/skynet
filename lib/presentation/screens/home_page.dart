...
import 'package:skynet/presentation/screens/story_screen.dart';
import 'package:skynet/presentation/screens/trust_payment_page.dart';
import 'package:skynet/presentation/widgets/active_services.dart';
import 'package:skynet/presentation/widgets/custom_appbar.dart';
import 'package:skynet/presentation/widgets/custom_container.dart';
import 'package:skynet/presentation/widgets/custom_pay_button.dart';
import 'package:skynet/presentation/widgets/history_operation_button.dart';
import 'package:skynet/presentation/widgets/licevoi_shet.dart';
import 'package:skynet/presentation/widgets/show_balance.dart';
                            ...
                            children: [
                              Padding(
                                ...
                                child: SizedBox(
                                  ...
                                  child: ListView.builder(
                                      ...
                                      itemCount: StoryModelData.stories.length,
                              ...
                              Padding(
                                ...
                                child: Container(
                                  ...
                                  child: Padding(
                                    padding: EdgeInsets.symmetric(
                                        horizontal: widget.screenWidth * 0.041,
                              ...
                              Padding(
                                padding: EdgeInsets.only(
                                    top: widget.screenHeight * 0.038, left: 25),
                                child: const Column(
                                  crossAxisAlignment: CrossAxisAlignment.start,
                                  children: [
                                    Text(
